Build a complete landing page as the single file `v3.html`.

Brand:
Adinaht International (อาดินาถเพื่อสากล ประเทศไทย) is a brand that offers Thai herbal products like soaps and body scrubs. They also support international peace, good traditions and culture, merit-making, and donations. The desired style is elegant and luxurious.

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
Rigid 12-column Swiss grid with full-width flat-color band headers dividing equal-measure three-column product rows, no decorative flourish — geometric sans at aggressive scale contrast (96px titles beside 11px labels) + italic Thai serif for ingredient names — cool porcelain grey #7D8FA3 + chalk white #EBE6DE + royal violet #4B1E91 + pewter #B8C0C8 (Benjarong celadon ground meets Chakri enamel) — institutional calm elevated into quiet aspiration
